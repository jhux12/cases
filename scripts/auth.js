...
window.addEventListener('DOMContentLoaded', () => {
    ...
    firebase.auth().onAuthStateChanged(async (user) => {
        ...
        if (user) {
            ...
            if (balanceAmount)
                balanceAmount.innerText = balanceFormatted;
            if (balanceMobile)
            ...
            if (userBalanceWrapper)
                userBalanceWrapper.classList.remove('hidden');
            ...
            if (signinDesktop)
                signinDesktop.style.display = "none";
            ...
            // Signed out state
            if (userBalanceWrapper)
                userBalanceWrapper.classList.add('hidden');
            if (balanceAmount)
            ...
            if (signinDesktop)
                signinDesktop.style.display = "block";
            if (mobileAuthButton) {
