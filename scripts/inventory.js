...
function initAddressAutocomplete() {
  ...
  // Tear down any previous autocomplete to avoid multiple listeners
  if (addressAutocomplete) {
    google.maps.event.clearInstanceListeners(addressAutocomplete);
...
function shipSelected() {
  ...
  const popup = document.getElementById('shipment-popup');
