...
function renderCases(caseList, reset = true) {
  ...
  toRender.forEach(c => {
    ...
    const priceIcon = c.isFree
      ? ""
      : '<img src="https://firebasestorage.googleapis.com/v0/b/hyperdrop-6476c.firebasestorage.app/o/packswebp%2Fripzacoin.webp?alt=media&token=e04bf3dc-a5b1-4b7e-89e1-125e144a3013" alt="Gems" class="h-4 w-4 ml-1 gem-icon">';
